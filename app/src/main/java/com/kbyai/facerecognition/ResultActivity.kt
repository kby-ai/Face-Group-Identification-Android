...
//        val pitch = intent.getFloatExtra("pitch", 0f)
        ...
        findViewById<ImageView>(R.id.imageEnrolled).setImageBitmap(enrolledFace0)
        findViewById<ImageView>(R.id.imageIdentified).setImageBitmap(identifyedFace0)
...
//        findViewById<TextView>(R.id.textPitch).text = "Pitch: " + pitch
        ...
        findViewById<ImageView>(R.id.imageEnrolled1).setImageBitmap(enrolledFace1)
        findViewById<ImageView>(R.id.imageIdentified1).setImageBitmap(identifyedFace1)
